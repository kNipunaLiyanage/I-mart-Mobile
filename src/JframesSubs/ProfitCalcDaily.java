 ...
 * @author Nipuna
 */
public class ProfitCalcDaily extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 340, 50));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1320, 10, -1, 50));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 70, 900, 30));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 100, 1360, 170));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 600, 560, 140));

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(51, 0, 255));
        jLabel7.setText("Total profit from repairs today is LKR ");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 540, 610, 30));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 370, 1360, 140));
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 280, 900, 30));
        ...
        getContentPane().add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 600, 730, 150));

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 0, 102));
        jLabel9.setText("Total our loss from repairs today is LKR ");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 540, 750, 30));
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 330, 900, 30));

        jLabel4.setFont(new java.awt.Font("OCR A Extended", 1, 24)); // NOI18N
        jLabel4.setText("Total profit is");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 10, 780, 40));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/background/white2.png"))); // NOI18N
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1380, 760));

        setSize(new java.awt.Dimension(1382, 761));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfitCalcDaily.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loaddata() {
        try {
            ...
            ResultSet rs = DB.search("select * from invoiceitems where statusz='SOLD' and datez='" + date_systemadd + "' and paytype='CASH'");
            while (rs.next()) {
                Vector v = new Vector();
            ...
            to1 = totalproficalc;
            jLabel5.setText("Total profit from CASH invoices today is LKR  " + totalproficalc);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void loaddata2() {
        try {
            ...
            ResultSet rs = DB.search("select * from invoiceitems where statusz='SOLD' and datez='" + date_systemadd + "' and paytype='CARD'");
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("invoiceID"));
                v.add(rs.getString("modelz"));
            ...
            tot2 = totalproficalc;
            jLabel8.setText("Total profit from CARD invoices today is LKR  " + totalproficalc);
            jLabel10.setText("Bank cost from CARD invoices today is LKR  " + bankuwatawatenagana);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void loaddata3() {
        try {
            ...
            System.out.println("call");
            double totalproficalc = 0;
            ResultSet rs = DB.search("select * from completedrepairs where datez='" + date_systemadd + "'");
            while (rs.next()) {
                Vector v = new Vector();
            ...
            tot3 = totalproficalc;
            jLabel7.setText("Total income from repairs today is LKR  " + totalproficalc);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void loaddata4() {
        try {
            ...
            System.out.println("call");
            double totalproficalc = 0;
            ResultSet rs = DB.search("select * from returnbacktocustomer where date='" + date_systemadd + "'");
            while (rs.next()) {
                Vector v = new Vector();
            ...
            tot4 = totalproficalc;
            jLabel9.setText("Total cost from returned item today is LKR  " + totalproficalc);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void finaltotalcal() {
        try {
            ...
            double dd2 = dd1 - tot4;
            jLabel4.setText("Total profit today is "+dd2);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
